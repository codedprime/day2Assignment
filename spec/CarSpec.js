(function(){
	...
	describe ("Car class: create a car, make it drive", function(){
		...
		it("A car should return the number of it's wheels", function(){
			var spider = new Car("Toyota", "Spider","Silver",2015);
			expect(spider.getWheels()).toEqual(4);
		});
		...
		it("A Smart Car should have 4 wheels ", function(){
			var myFerrari = new SmartCar("Ferrari", "California","Red",2016);
			expect(myFerrari.getWheels()).toEqual(4);
	...
	describe("Test the speed functionality", function() {
		...
		it("A Smart Car should nitro boost without the minimum 3km/h for normal cars ", function(){
			var myFerrari = new SmartCar("Ferrari", "California","Red",2016);
			expect(myFerrari.nitroBoost(5)).toBeGreaterThan(0);
